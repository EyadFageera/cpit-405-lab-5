...
const player_rows = document.getElementById("player-rows");

const dropDownMenu = document.getElementById('team-filter');
...
function populatetable(players) {
    ...
    players.forEach(player => {
        ...
        row.innerHTML = `
            ...
            `;
        player_rows.appendChild(row);
        if(teams.includes(player.team) === false){
...
function populateopt(teams){
    dropDownMenu.innerHTML= '';

    let defaultOption = document.createElement('option');
    defaultOption.innerHTML = 'All Teams';
    defaultOption.value = '';
...
let inputSearchElem = document.getElementById("search")
inputSearchElem.addEventListener("keyup", filterByName)

let selectBroadcasterElem = document.getElementById("team-filter")
selectBroadcasterElem.addEventListener("change", filterByTeam)
